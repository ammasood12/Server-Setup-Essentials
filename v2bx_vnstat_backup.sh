...
show_dashboard() {
 ...
 echo ""
 echo -e " ${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
 echo -e " ${WHITE}    V2bX & vnstat Backup/Restore Tool${NC} ${CYAN}v${SCRIPT_VERSION}${NC}"
 echo -e " ${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
 
 # System Info
 echo -e " ${BLUE}▸${NC} ${CYAN}System:${NC} ${WHITE}$OS $VER ($PKG_MANAGER)${NC} (${CYAN}Kernel:${WHITE}$(uname -r | cut -d'-' -f1)${NC})"
 ...
 if [ "$V2BX_INSTALLED" = true ]; then
  if [ "$V2BX_RUNNING" = true ]; then
   echo -e "   ${GREEN}●${NC} V2bX ${WHITE}$V2BX_VERSION${NC} - ${GREEN}Running${NC}  ${BLUE}[${WHITE}$V2BX_PATH${BLUE}]${NC}"
  else
   echo -e "   ${RED}●${NC} V2bX ${WHITE}$V2BX_VERSION${NC} - ${RED}Stopped${NC}  ${BLUE}[${WHITE}$V2BX_PATH${BLUE}]${NC}"
  fi
 else
 ...
 if command -v vnstat >/dev/null 2>&1; then
  if [ "$VNSTAT_RUNNING" = true ]; then
   echo -e "   ${GREEN}●${NC} vnstat ${WHITE}$VNSTAT_VERSION${NC} - ${GREEN}Running${NC}  ${BLUE}[${WHITE}$VNSTAT_PATH${BLUE}]${NC}"
  else
   echo -e "   ${RED}●${NC} vnstat ${WHITE}$VNSTAT_VERSION${NC} - ${RED}Stopped${NC}  ${BLUE}[${WHITE}$VNSTAT_PATH${BLUE}]${NC}"
  fi
 else
 ...
 # Backup Info
 echo -e " ${YELLOW}▸ Backups:${NC}   ${WHITE}$BACKUP_COUNT${NC} total"
 echo -e " ${YELLOW}▸ Latest: ${NC}   ${WHITE}$LAST_BACKUP${NC}"
 echo -e " ${YELLOW}▸ Directory:${NC} ${WHITE}$BACKUP_DIR${NC}"
}
...
show_menu() {
 ...
 echo -e " ${WHITE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
 echo -e "   1. Create backup      5. Show backup info"
 echo -e "   2. Restore backup     6. Install V2bX"
 echo -e "   3. List backups       7. Install vnstat"
 echo -e "   4. Cleanup            8. Start/restart services"
